...
Launch the interactive chat server:
...
For a detailed comparison of observability platforms (LangSmith, Arize Phoenix, AgentOps, Braintrust, Helicone) and the full self-hosting setup, see [`observability.ipynb`](../notebooks/observability.ipynb).
