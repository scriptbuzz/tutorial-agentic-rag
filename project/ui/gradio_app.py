...
def create_gradio_ui():
    """
    Constructs the Gradio user interface blocks.
    It separates the interaction into two tabs:
    1. 'Documents': For uploading and managing the knowledge base.
    2. 'Chat': For interacting with the Agentic RAG system.
    """
